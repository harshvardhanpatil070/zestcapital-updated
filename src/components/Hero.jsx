    ...
    <section className="relative w-full h-screen flex items-center justify-center bg-gradient-to-br from-[#0C056D] to-[#120A8F] overflow-hidden">
      ...
      <motion.div
        className="relative text-center text-white px-6 md:px-12 lg:px-24 
                   transform scale-90 md:scale-100 transition-transform"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, ease: "easeOut" }}
      >
        {/* Reduced heading sizes */}
        <h1 className="text-3xl md:text-5xl font-extrabold drop-shadow-lg leading-tight whitespace-nowrap">
          Your Future, Our Priority with
        </h1>
        <h2 className="text-3xl md:text-5xl font-extrabold drop-shadow-lg leading-tight whitespace-nowrap mt-2">
          Zest Capital
        </h2>
